...
public class LocationData {
    public List<Location> Data(){
        ...
        data.add(new Location(2, "Tầng 25, Tòa nhà Lim Tower, 9 - 11 Tôn Đức Thắng, Phường Bến Nghé, Quận 1, Thành phố Hồ Chí Minh",new Company(1),new CityProvince(1)));
        data.add(new Location(3, "Tòa nhà LPB, số 210 Trần Quang Khải, Phường Tràng Tiền, Quận Hoàn Kiếm, Thành phố Hà Nội",new Company(1),new CityProvince(2)));
        return data;
    }
}
